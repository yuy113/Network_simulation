#' Generate edge scores for biological correlation network baP values by multiple permulation tests on all the possible edges
#' in biological network based on multiple hyposist testing on pairwise correlations 
#' 
#' This function calculate edge scores based on P values in multiple testing 
...
#' @param pval  P values from multiple hypothesis testing in vector format
#'  The names of the edges (names of two connecting nodes(variables)) must be specified.
#' @param fdr the level of False Discovery Rate for multiple testing
#'   
...
#' pval.perm.corr(dat1,nsim=100000,MatchId=NA,do.parallel=F)  
#'    
#' @export
